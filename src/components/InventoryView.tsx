...
import { Cloud, Server, Power, PowerOff } from 'lucide-react';

interface InventoryViewProps {
  instances: Instance[];
}

export function InventoryView({ instances }: InventoryViewProps) {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">AWS Inventory</h1>
          <p className="text-slate-400 mt-1">Dynamic inventory managed via AWS EC2 plugin.</p>
        </div>
